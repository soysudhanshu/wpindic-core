...
class MalyalamTransliterator  extends LanguageTransliteratorInterface {
    ...
    static _getTransliteration(word){
        return GoogleTransliterator.transliterate(word, 'ml');
    }
...
export default MalyalamTransliterator;