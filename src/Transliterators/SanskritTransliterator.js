...
class SanskritTransliterator  extends LanguageTransliteratorInterface{
    ...
    static _getTransliteration(word){
        return GoogleTransliterator.transliterate(word, 'sa');
    }
...
export default SanskritTransliterator;