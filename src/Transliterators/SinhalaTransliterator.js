...
class SinhalaTransliterator  extends LanguageTransliteratorInterface{
    ...
    static _getTransliteration(word){
        return GoogleTransliterator.transliterate(word, 'si');
    }
...
export default SinhalaTransliterator;