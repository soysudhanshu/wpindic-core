...
class NepaliTransliterator  extends LanguageTransliteratorInterface {
    ...
    static _getTransliteration(word){
        return GoogleTransliterator.transliterate(word, 'ne');
    }
...
export default NepaliTransliterator;