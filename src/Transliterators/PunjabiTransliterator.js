...
class PunjabiTransliterator  extends LanguageTransliteratorInterface{
    ...
    static _getTransliteration(word){
        return GoogleTransliterator.transliterate(word, 'pa');
    }
...
export default PunjabiTransliterator;